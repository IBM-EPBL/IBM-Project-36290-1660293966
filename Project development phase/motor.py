...
organization = "rwgui4" #replace the ORG ID
deviceType = "NodeAPOS"#replace the Device type wi
deviceId = "972001"#replace Device ID
authMethod = "token"
authToken = "Licet@123" #Replace the authtoken
